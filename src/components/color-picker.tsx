...
import bgImage from '../../public/color1.jpg'; 
...
/>
      ...
      <Card className=" relative w-full max-w-md mx-auto p-8 grid gap-8 shadow-lg rounded-2xl bg-gradient-to-br from-pink-400 to-teal-400">
